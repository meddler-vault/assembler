...
docker run  --env-file .env -v /tmp/store/:/workspace/  rounak316/kaniko_test --context=git://github.com/meddler-io/test-docker-image.git --force   --no-push --tarPath=/workspace/image.tar
